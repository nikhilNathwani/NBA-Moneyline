"""
Tests for the pure URL-construction/matching helpers in scrape.helpers.
...
from scrape.helpers import makeSeasonSpecificUrl, makeCurrentSeasonUrl, urlMatchesRequestedSeason
